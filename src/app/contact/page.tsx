...
const Contact: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="min-h-screen relative px-0 md:px-10 mb-16 pt-12 z-10"
    >
      {/* Background Text */}
      <div
      ...
      <div className="flex flex-col gap-7 mx-10 mt-18 md:mt-0 text-white">
        {/* Header */}
              ...
              >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`input input-bordered w-full bg-base-100 bg-opacity-50 focus:bg-opacity-70 transition-all duration-300 ${
                      errors.name ? "border-red-500" : "focus:border-[#49C5B6]"
                    }`}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`input input-bordered w-full bg-base-100 bg-opacity-50 focus:bg-opacity-70 transition-all duration-300 ${
                      errors.email ? "border-red-500" : "focus:border-[#49C5B6]"
                    }`}
                    {...register("email", {
