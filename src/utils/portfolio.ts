export const portfolio = [
  ...
  },
  {
    ...
    description:
      "Interactive React Flash Cards project for effective learning and review.",
    tag: "project",
  ...
  },
  {
    ...
    description:
      "Amazon Social prototype, enhancing user engagement with Twitter-inspired features. Explore the design on Figma",
    tag: "project",
  ...
  },
  {
    ...
    description:
      "Comprehensive guide for beginners on Node.js frameworks, available on LinkedIn",
    tag: "post",
  ...
  },
  {
    ...
    description:
      "Exploration of daisyUI with Next.js 14 and TailwindCSS, detailed in a LinkedIn post",
    tag: "post",
